      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-12 md:space-y-0">
          ...
          <div className="flex flex-col md:items-end space-y-4">
            ...
            <a href="mailto:hello@clarityflow.studio" className="text-[#f5f1e6]/60 hover:text-[#00f3ff] transition-colors">hello@clarityflow.studio</a>
            <a href="https://t.me/clarityflow" className="px-6 py-2 bg-[#1a1a1a] rounded-full text-sm font-bold hover:bg-[#00f3ff] hover:text-[#0a0a0a] transition-all flex items-center gap-2">
        ...
        <div className="mt-20 pt-8 border-t border-[#f5f1e6]/5 flex flex-col md:flex-row justify-between items-center text-xs text-[#f5f1e6]/20 font-bold tracking-widest uppercase">
          <p>© {new Date().getFullYear()} ClarityFlow Studio. All rights reserved.</p>
